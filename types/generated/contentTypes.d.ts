...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    >;
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID<"heading2">;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<"oneToOne", "admin::user"> &
      Schema.Attribute.Private;
  };
...
export interface ApiB2BPageB2BPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    b2bConfigurator: Schema.Attribute.Component<
      "b2-b.b2b-configurator",
      false
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
...
export interface ApiCompanyAndTeamCompanyAndTeam
  extends Struct.SingleTypeSchema {
  collectionName: "company_and_teams";
  info: {
    description: "";
    displayName: "Company And Team Page";
    pluralName: "company-and-teams";
    singularName: "company-and-team";
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<"oneToOne", "admin::user"> &
      Schema.Attribute.Private;
    faq: Schema.Attribute.Component<"company.faq", false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiFaqFaq extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    answerContent: Schema.Attribute.Blocks &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiFaqsPageFaqsPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<"oneToOne", "admin::user"> &
      Schema.Attribute.Private;
    faqTabs: Schema.Attribute.Component<"faq.faq-tabs", true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiLayoutLayout extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    header: Schema.Attribute.Component<"ui.header", false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiLocationLocation extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    >;
    mapCoordinates: Schema.Attribute.Component<"shared.center", false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    slug: Schema.Attribute.UID<"heading1"> &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
...
export interface ApiProjectProject extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    carouselHero: Schema.Attribute.Media<
      "images" | "files" | "videos" | "audios"
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
    ...
    hasDetailsPage: Schema.Attribute.Boolean &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    projectHashId: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiProjectsPageProjectsPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    projectsTable: Schema.Attribute.Component<
...
declare module "@strapi/strapi" {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      "api::reonic-script.reonic-script": any;
    }
  }
}
